    ...
    <footer className="footer-section">
      ...
      <div className="footer-content">
        ...
        <nav className="footer-nav">
          ...
          <a href="https://github.com/aayush-1709/Drive-Detect" target="_blank" rel="noopener noreferrer" aria-label="GitHub">GitHub</a>
        </nav>
        <div className="footer-social">
          <a href="https://github.com/aayush-1709/Drive-Detect" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
